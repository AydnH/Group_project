...
export class PermissionPage extends React.Component {
  render() {
    ...
    <p><center><b>Allow Connection to access Device:</b></center></p>
      ...
      <Formik
        intialValues={{Location:true,Camera:true,Microphone:true, Contacts:true, CameraRoll:true, History:true,ThirdParty:true}}
        ...
        onSubmit={(values, {setSubmitting}) => {
          ...
          axios.post('https://connectproject.herokuapp.com/api/put-Permissions',{
